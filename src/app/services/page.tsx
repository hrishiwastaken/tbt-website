...
function Leaf({ double, size, rotate, flip, opacity, pos, drift = "slow", color = "teal", mobileHidden }: LeafSpec) {
  return (
    <div
      aria-hidden="true"
...
const ROW_SCATTERS: LeafSpec[][] = [
  [
    { double: true, size: 165, rotate: -18, opacity: 0.07, pos: { top: "9%", right: "5%" } },
    { size: 75, rotate: 65, opacity: 0.05, pos: { top: "26%", left: "40%" }, drift: "reverse", color: "forest", mobileHidden: true },
    { size: 125, rotate: 118, flip: true, opacity: 0.06, pos: { bottom: "-3%", left: "7%" }, drift: "reverse" },
    { double: true, size: 58, rotate: 32, opacity: 0.05, pos: { top: "14%", left: "18%" }, color: "forest" },
  ],
  [
    { double: true, size: 140, rotate: 24, flip: true, opacity: 0.065, pos: { top: "6%", left: "4%" } },
    { size: 95, rotate: -40, opacity: 0.055, pos: { bottom: "12%", right: "8%" }, drift: "reverse", color: "forest" },
    { size: 60, rotate: 150, opacity: 0.05, pos: { top: "48%", right: "34%" }, mobileHidden: true },
    { double: true, size: 80, rotate: -8, opacity: 0.045, pos: { bottom: "-4%", left: "44%" }, drift: "reverse", mobileHidden: true },
  ],
  [
    { size: 150, rotate: -75, opacity: 0.06, pos: { top: "18%", right: "2%" }, drift: "reverse" },
    { double: true, size: 70, rotate: 45, opacity: 0.055, pos: { top: "8%", left: "30%" }, color: "forest", mobileHidden: true },
    { double: true, size: 110, rotate: 12, flip: true, opacity: 0.065, pos: { bottom: "5%", left: "2%" } },
    { size: 55, rotate: -130, opacity: 0.05, pos: { bottom: "24%", right: "26%" }, drift: "reverse", color: "forest", mobileHidden: true },
  ],
];
...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "A neutral, structured environment for couples and family systems alike. Address relational conflict, build communication bridges, improve boundary-setting, and restore emotional connection — whether between partners or across the whole family.",
  ...
  return (
    <div className="bg-warm-sand min-h-screen font-dmsans">
      ...
      <section className="bg-warm-tan/30 pt-32 pb-20 border-b border-muted-sage/20 relative overflow-hidden">
        ...
        <Leaf double size={190} rotate={-12} opacity={0.06} pos={{ top: "12%", right: "7%" }} />
        <Leaf size={90} rotate={70} opacity={0.05} pos={{ top: "58%", right: "22%" }} drift="reverse" color="forest" mobileHidden />
        <Leaf size={145} rotate={40} flip opacity={0.05} pos={{ bottom: "-6%", left: "5%" }} drift="reverse" color="forest" />
        <Leaf double size={65} rotate={-55} opacity={0.05} pos={{ top: "22%", left: "14%" }} mobileHidden />
      ...
      <section className="py-24 bg-muted-sage/20 relative overflow-hidden">
        ...
        <Leaf double size={210} rotate={8} opacity={0.06} pos={{ bottom: "6%", right: "3%" }} drift="reverse" color="forest" />
        <Leaf size={85} rotate={-95} opacity={0.05} pos={{ top: "10%", left: "6%" }} />
        <Leaf double size={60} rotate={130} flip opacity={0.045} pos={{ top: "38%", right: "12%" }} mobileHidden />
        <Leaf size={115} rotate={20} opacity={0.05} pos={{ bottom: "-2%", left: "34%" }} drift="reverse" mobileHidden />
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          {/* Header */}
