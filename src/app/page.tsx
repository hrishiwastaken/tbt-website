...
export default function Home() {
  ...
  const focusAreas = [
    {
      ...
      description:
        "Persistent worry, panic, and burnout are treatable. We help you build tools that last.",
    },
    {
      icon: <Heart className="w-6 h-6 text-forest" />,
      title: "Depression & Mood",
      description:
        "Whether it's emptiness or constant sadness, you don't have to carry it alone.",
    },
    {
      icon: <Users className="w-6 h-6 text-forest" />,
      title: "Relationship Therapy",
      description:
        "For couples and individuals navigating connection, conflict, and intimacy.",
    },
    {
      icon: <ShieldAlert className="w-6 h-6 text-forest" />,
      title: "Trauma & PTSD",
      description:
        "Gentle, trauma-informed care to help you process and move forward safely.",
    },
    {
      icon: <Sparkles className="w-6 h-6 text-forest" />,
      title: "Self-Esteem & Identity",
      description:
        "Explore who you are and build a relationship with yourself that's grounded and compassionate.",
    },
    {
      icon: <Compass className="w-6 h-6 text-forest" />,
      title: "Life Transitions",
      description:
        "Grief, career change, parenthood, loss — we help you navigate what comes next.",
    },
  ];
  ...
  const steps = [
    {
      ...
      title: "Reach Out",
      description:
        "Send us a WhatsApp message or fill out the contact form. We'll respond within 24 hours.",
    },
    {
      num: "02",
      title: "Free Consultation",
      description:
        "A short, no-pressure call to understand your needs and match you with the right therapist.",
    },
    {
      num: "03",
      title: "Begin Your Journey",
      description:
        "Book your first session at a time that works for you, in person or online.",
    },
  ];
  ...
  return (
    <div className="overflow-hidden bg-ivory font-dmsans">
        ...
        <section className="relative min-h-[90vh] pt-28 md:pt-[120px] pb-20 md:pb-24 bg-warm-white rounded-b-[120px] md:rounded-b-[360px] overflow-hidden shadow-sm z-20">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center lg:-ml-20 relative z-10">
              <div className="bg-warm-white p-8 md:p-16 lg:py-20 lg:px-24 rounded-[40px] lg:rounded-l-[140px] lg:rounded-r-[40px] border border-muted-sage/20 shadow-warm-soft max-w-2xl">
                ...
                <p className="text-sm md:text-base text-forest-slate/90 leading-relaxed mb-8 font-dmsans text-pretty">
                  Compassionate, evidence-based therapy for individuals,
                  couples, and families. A warm, clinical sanctuary to begin
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 mt-20 md:mt-32">
            ...
            <div className="max-w-6xl mx-auto mb-8 relative px-4">
              ...
              <div className="hidden md:flex justify-between items-center w-full absolute top-1.5 left-0 right-0 pointer-events-none z-0">
                <span className="text-[10px] font-bold tracking-[0.25em] text-teal-sage uppercase">
                  Your Journey
                </span>
                <span className="text-[10px] font-bold tracking-[0.25em] text-teal-sage uppercase">
                  Starts Here
              ...
              <div className="text-center max-w-xl mx-auto relative z-10 text-forest-slate">
                ...
                <p className="text-forest-slate/85 text-xs md:text-sm leading-relaxed font-dmsans max-w-md mx-auto text-pretty">
                  We provide structured support pathways for various clinical
                  mental health requirements, using approaches proven to make a
                  lasting difference.
                </p>
              </div>
            </div>
      ...
      <section className="bg-muted-sage pt-12 pb-16 md:pb-24 relative">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative">
          {/* Arch-topped Cards Grid with negative top margin to overlap the transition */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto -mt-24 md:-mt-36 lg:-mt-44 relative z-30">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="bg-warm-white rounded-b-[24px] w-full px-5 py-6 text-center shadow-warm-soft -mt-1 border border-t-0 border-warm-sand/15">
                <h3 className="font-cormorant text-xl md:text-2xl font-semibold text-forest-slate mb-2 uppercase tracking-wide">
                  Individual Therapy
                </h3>
                <p className="text-xs md:text-sm text-forest-slate/80 leading-relaxed mb-5 font-dmsans">
                  One-on-one sessions tailored specifically to you. Process
                  emotional pain, challenge deep-seated patterns, and build
                  genuine coping skills.
                </p>
                <Link
                  href="/book"
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="bg-warm-white rounded-b-[24px] w-full px-5 py-6 text-center shadow-warm-soft -mt-1 border border-t-0 border-warm-sand/15">
                ...
                <p className="text-xs md:text-sm text-forest-slate/80 leading-relaxed mb-5 font-dmsans">
                  A structured, neutral space for couples and families alike —
                  resolve conflict, dismantle communication barriers, strengthen
                  boundaries, and restore connection.
                </p>
                <Link
                  href="/book"
                  className="font-dmsans text-[10px] font-bold tracking-[0.2em] text-teal-sage hover:text-forest-slate uppercase underline underline-offset-4"
      ...
      <section className="py-16 md:py-24 bg-warm-white relative">
        ...
        <div className="absolute bottom-0 left-0 right-0 w-full overflow-hidden leading-none z-10 pointer-events-none">
          <svg
            className="relative block w-full h-[50px] md:h-[60px]"
            viewBox="0 0 1200 120"
            preserveAspectRatio="none"
          >
            <path
              d="M0,0 Q600,100 1200,0 L1200,120 L0,120 Z"
              fill="var(--color-warm-sand)"
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              <div className="bg-muted-sage/10 border border-muted-sage/20 p-5 rounded-2xl space-y-2 mb-6 max-w-lg shadow-sm">
                ...
                <p className="text-xs text-forest-slate/80 leading-relaxed font-dmsans">
                  Every session is conducted with absolute privacy under strict
                  clinical ethics. Your session speed, topics of discussion, and
                  emotional boundaries are completely controlled by you.
                </p>
              </div>
      ...
      <section className="py-20 md:py-28 bg-warm-white text-forest-slate relative overflow-hidden">
      ...
      <section className="py-16 md:py-24 bg-warm-sand/35 text-center relative overflow-hidden">
