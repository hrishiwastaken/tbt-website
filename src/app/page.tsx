...
export default function Home() {
  ...
  return (
    <div className="overflow-hidden bg-ivory font-dmsans">
      ...
      <section className="relative min-h-[90vh] pt-[120px] pb-[180px] md:pb-[290px] bg-warm-white overflow-hidden shadow-sm z-20">
        ...
        <div className="absolute bottom-0 left-0 right-0 w-full overflow-hidden leading-none z-20 pointer-events-none">
          <svg className="relative block w-full h-[150px] md:h-[260px]" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M0,0 Q600,120 1200,0 L1200,120 L0,120 Z" fill="var(--color-muted-sage)" />
          </svg>
        </div>
      </section>
