...
export default function Home() {
  ...
  const message = "Hello! I'd like to book an appointment at The Brain Tea. Could you please let me know your availability?";
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto -mt-24 md:-mt-36 lg:-mt-44 relative z-30">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="bg-warm-white rounded-b-[24px] w-full px-5 py-6 text-center shadow-warm-soft -mt-1 border border-t-0 border-warm-sand/15">
                <h3 className="font-cormorant text-xl md:text-2xl font-semibold text-forest-slate mb-2 uppercase tracking-wide">Couples &amp; Family Therapy</h3>
                <p className="text-xs md:text-sm text-forest-slate/80 leading-relaxed mb-5 font-dmsans">
                  A structured, neutral space for couples and families alike — resolve conflict, dismantle communication barriers, strengthen boundaries, and restore connection.
                </p>
                <Link
                  href="/book"
                  className="font-dmsans text-[10px] font-bold tracking-[0.2em] text-teal-sage hover:text-forest-slate uppercase underline underline-offset-4"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              <div className="space-y-4 font-dmsans text-base text-forest-slate/90 leading-relaxed mb-6 text-pretty">
                ...
                <p>
                  At The Brain Tea, therapy is entirely self-paced. We prioritize your emotional safety, personal boundaries, and absolute privacy. Our space is designed to be a sanctuary where you can catch your breath and begin your healing journey without any pressure or judgment.
                </p>
              </div>
