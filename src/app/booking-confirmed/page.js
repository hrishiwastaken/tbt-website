  ...
  return (
    <main className="flex-grow w-full max-w-4xl mx-auto px-6 md:px-12 py-28 text-center">
      <div className="glass-card rounded-2xl p-8 md:p-12 border border-mist/30 shadow-warm-soft max-w-2xl mx-auto flex flex-col items-center">
        ...
        <span className="font-dmsans text-xs font-bold tracking-widest text-terracotta uppercase block mb-2">Reservation Completed</span>
        <h1 className="font-cormorant text-4xl font-semibold text-charcoal mb-4">Your Slot is Reserved</h1>
        ...
        <div className="w-full bg-warm-white/50 rounded-xl border border-mist/20 p-6 flex flex-col gap-4 text-left mb-8 font-dmsans text-sm">
          <div className="flex justify-between items-center border-b border-mist/10 pb-3">
            <span className="text-xs font-bold uppercase text-sage">Receipt Number</span>
          ...
          <div className="flex justify-between items-center border-b border-mist/10 pb-3">
            <span className="text-xs font-bold uppercase text-sage">Practitioner</span>
            <span className="text-charcoal font-semibold">{booking.therapist.name}</span>
          </div>

          <div className="flex justify-between items-center border-b border-mist/10 pb-3">
            <span className="text-xs font-bold uppercase text-sage">Service</span>
            <span className="text-charcoal font-semibold">{booking.service.name}</span>
          </div>

          <div className="flex justify-between items-center border-b border-mist/10 pb-3">
            <span className="text-xs font-bold uppercase text-sage">Date & Time</span>
          ...
          <div className="flex justify-between items-center">
            <span className="text-xs font-bold uppercase text-sage">Payment Status</span>
        ...
        <div className="text-left font-dmsans text-xs text-sage leading-relaxed border-t border-mist/20 pt-6 w-full">
          <h4 className="font-bold text-charcoal mb-2">Important Session Guidelines:</h4>
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>WhatsApp reminders with session logs will be sent 24 hours and 1 hour before start.</li>
          </ul>
        </div>
