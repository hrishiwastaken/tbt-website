...
export default function SectionHeading({
  ...
  return (
    ...
    >
      ...
      <h2 className="font-cormorant text-3xl md:text-4xl lg:text-5xl font-semibold text-forest-slate leading-tight text-balance">
        {title}
        {handwritten && (
          <span className="block font-cormorant italic text-2xl md:text-3xl text-teal-sage font-normal mt-1">
            {handwritten}
          </span>
        )}
      </h2>
