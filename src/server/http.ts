...
export const unauthorized = (msg = "Unauthorized access") =>
...
export async function requireTherapist(
  ...
  if (!therapist)
    throw forbidden("No consultant profile is linked to this account");
...
export function parseBody<S extends ZodSchema>(
  schema: S,
  raw: unknown,
): S["_output"] {
