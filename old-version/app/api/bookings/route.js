  ...
  try {
    ...
    if (paymentOption === "PAY_NOW") {
      try {
        ...
        // The customer paid via the UPI QR and provided the 12-digit UTR as proof.
        // Register the payment immediately so the booking is confirmed and shows as
        // received in the website / admin ledger (admin can still reconcile the UTR
        ...
        // Log the successful transaction in the payments ledger
